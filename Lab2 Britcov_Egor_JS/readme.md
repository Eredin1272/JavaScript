...
![Уникальные типы транзакций](../JS/screenshots/1.png)
---
- **Общая сумма транзакций:**
![Общая сумма транзакций](../JS/screenshots/2.png)
---
- **Общая сумма транзакций за выбранный период:**
![Общая сумма транзакций за выбранный период](../JS/screenshots/3.png)
---
- **Только тип "Доходы":**
![Только тип "Доходы"](../JS/screenshots/4.png)
---
- **Транзакции за выбранный месяц:**
![Транзакции за март](../JS/screenshots/5.png)
---
- **Транзакции в выбранном магазине:**
![Транзакции в магазине "Bomba"](../JS/screenshots/6.png)
---
- **Средняя сумма транзакций:**
![Средняя сумма транзакций](../JS/screenshots/7.png)
---
- **Транзакции в указанном диапазоне сумм:**
![Диапазон сумм](../JS/screenshots/8.png)
---
- **Общая сумма дебитовых карт:**
![Сумма дебитовых карт](../JS/screenshots/9.png)
---
- **Месяц с наибольшим числом транзакций:**
![Месяц с наибольшим числом транзакций](../JS/screenshots/10.png)
---
- **Месяц с наибольшим числом дебитовых транзакций:**
![Месяц с наибольшим числом дебитовых транзакций](../JS/screenshots/11.png)
---
- **Каких транзакций больше:**
![Каких транзакций больше](../JS/screenshots/12.png)
---
- **Транзакции до указанной даты:**
![Транзакции до 2025-04-01](../JS/screenshots/13.png)
---
- **Транзакции по ID:**
![Транзакции по ID](../JS/screenshots/14.png)
---
- **Описание всех транзакций:**
![Описание всех транзакций](../JS/screenshots/15.png)
---
- **Тест с пустым массивом**
![Тест с пустым массивом](../JS/screenshots/16.png)
---
